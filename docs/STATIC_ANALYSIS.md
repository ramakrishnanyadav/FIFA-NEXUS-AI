...
- **Vulnerabilities Identified**: Found 23 known vulnerabilities in 5 packages:
  ...
  - *Note: langchain-core, langgraph, langsmith, and this pip/starlette version are venv artifacts from unrelated experimentation, not resolved dependencies of this project (see [DEPENDENCY_AUDIT.md](DEPENDENCY_AUDIT.md)).*
